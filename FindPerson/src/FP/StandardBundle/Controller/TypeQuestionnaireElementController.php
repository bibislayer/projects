...
use FP\StandardBundle\Entity\StdQuestionnaireTypeElement;
use FP\StandardBundle\Form\StdQuestionnaireTypeElementType;
...
class TypeQuestionnaireElementController extends Controller
{
    public function boIndexAction() {
        ...
        $paginate->setView('FPStandardBundle:TypeQuestionnaireElement:index.html.twig');
    ...
    public function boShowAction($id) {
        ...
        if($typeQuestionnaireElement){
            ...
            $breadcrumbs->addItem('');
            return $this->render('FPStandardBundle:TypeQuestionnaireElement:show.html.twig', array( 'typeQuestionnaireElement' => $typeQuestionnaireElement));
        }else{
    ...
    public function typeQuestionnaireElementFormAction(){
        ...
        $formConf->setView('FPStandardBundle:TypeQuestionnaireElement:type_questionnaire_element_form.html.twig');
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $typeQuestionnaire = $em->getRepository('FPStandardBundle:StdQuestionnaireTypeElement')->find($id);
