...
class ProfileController extends Controller implements ContainerAwareInterface
{
    ...
    public function showAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('FPUserBundle:Profile:show.html.'.$this->container->getParameter('fos_user.template.engine'), array('user' => $user));
    }
    ...
    public function editAction(Request $request)
    {
        ...
        return $this->container->get('templating')->renderResponse(
            'FPUserBundle:Profile:edit.html.'.$this->container->getParameter('fos_user.template.engine'),
        ...
        return $this->render('FPUserBundle:Profile:tabsInfo.html.twig', array(
            'type' => $type,
        ));
