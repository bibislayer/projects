...
class IndexPaginate
{
    ...
    public function getTemplate()
    {
        switch($this->env):
            case 'bo_':
                if($this->ajax):
                    return 'FPGeneralBundle:Default:list.html.twig';
                else:
                    return 'FPGeneralBundle:Back:containerList.html.twig';
                endif;
                break;
            case 'mo_':
                if($this->ajax):
                    ...
                    return 'FPGeneralBundle:Middle:containerList.html.twig';
                endif;
                break;
            case 'fo_':
                if($this->ajax):
                    ...
                    return 'FPGeneralBundle:Front:containerList.html.twig';
                endif;
                break;
        endswitch;
    }
