...
class UserProfile
{
     ...
     * @return UserProfile
     */
    public function setUser(\SO\UserBundle\Entity\User $user = null)
    {
        $this->User = $user;
     ...
     * Add enterprises
     *
     * @param \SO\EnterpriseBundle\Entity\Enterprise $enterprises
     * @return UserProfile
     */
    public function addEnterprise(\SO\EnterpriseBundle\Entity\Enterprise $enterprises)
    {
     ...
     * @param \SO\EnterpriseBundle\Entity\Enterprise $enterprises
     */
    public function removeEnterprise(\SO\EnterpriseBundle\Entity\Enterprise $enterprises)
    {
