...
class IndexPaginate
{
     ...
     * @param $route
     */
    public function setAddNew($route)
    {
        $this->addUrl = $route;
    }
    /***
    ...
    public function getTemplate()
    {
        switch($this->env):
            case 'bo_':
                if($this->ajax):
                    return 'SOGeneralBundle:Default:list.html.twig';
                else:
                    return 'SOGeneralBundle:Back:containerList.html.twig';
                endif;
                break;
            case 'mo_':
                if($this->ajax):
                    ...
                    return 'SOGeneralBundle:Middle:containerList.html.twig';
                endif;
                break;
            case 'fo_':
                if($this->ajax):
                    ...
                    return 'SOGeneralBundle:Front:containerList.html.twig';
                endif;
                break;
        endswitch;
    }
