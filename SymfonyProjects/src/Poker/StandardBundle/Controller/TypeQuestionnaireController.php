...
use Poker\StandardBundle\Entity\StdQuestionnaireType;
use Poker\StandardBundle\Form\StdQuestionnaireTypeType;
...
class TypeQuestionnaireController extends Controller
{
    public function boIndexAction() {
        ...
        $paginate->setView('PokerStandardBundle:TypeQuestionnaire:index.html.twig');
    ...
    public function boShowAction($id) {
        ...
        if($typeQuestionnaire){
            ...
            $breadcrumbs->addItem('');
            return $this->render('PokerStandardBundle:TypeQuestionnaire:show.html.twig', array( 'typeQuestionnaire' => $typeQuestionnaire));
        }else{
    ...
    public function typeQuestionnaireFormAction(){
        ...
        $formConf->setView('PokerStandardBundle:TypeQuestionnaire:type_questionnaire_form.html.twig');
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $typeQuestionnaire = $em->getRepository('PokerStandardBundle:StdQuestionnaireType')->find($id);
