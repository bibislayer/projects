...
use Poker\StandardBundle\Entity\StdQuestionType;
use Poker\StandardBundle\Form\StdQuestionTypeType;
...
class TypeQuestionController extends Controller
{
    public function boIndexAction() {
        ...
        $paginate->setView('PokerStandardBundle:TypeQuestion:index.html.twig');
    ...
    public function boShowAction($id) {
        ...
        if($typeQuestion){
            ...
            $breadcrumbs->addItem('');
            return $this->render('PokerStandardBundle:TypeQuestion:show.html.twig', array( 'typeQuestion' => $typeQuestion));
        }else{
    ...
    public function typeQuestionFormAction(){
        ...
        $formConf->setView('PokerStandardBundle:TypeQuestion:type_question_form.html.twig');
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $typeQuestion = $em->getRepository('PokerStandardBundle:StdQuestionType')->find($id);
