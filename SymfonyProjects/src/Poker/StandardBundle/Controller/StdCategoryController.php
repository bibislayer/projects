...
use Poker\StandardBundle\Entity\StdCategory;
use Poker\StandardBundle\Form\StdCategoryType;
...
class StdCategoryController extends Controller {
    ...
    public function boIndexAction() {
        ...
        $paginate->setView('PokerStandardBundle:StdCategory/Back:index.html.twig');
    ...
    public function boShowAction($id) {
        ...
        if($category){
            ...
            $breadcrumbs->addItem('');
            return $this->render('PokerStandardBundle:StdCategory/Back:show.html.twig', array( 'category' => $category));
        }else{
    ...
    public function categoryFormAction(){
        ...
        $formConf->setView('PokerStandardBundle:StdCategory/Back:category_form.html.twig');
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $category = $em->getRepository('PokerStandardBundle:StdCategory')->find($id);
        if(is_object($category) && $category->getId()){
            $repo = $em->getRepository('PokerStandardBundle:StdCategory');
