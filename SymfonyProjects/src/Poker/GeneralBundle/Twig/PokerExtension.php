...
namespace Poker\GeneralBundle\Twig;

class PokerExtension extends \Twig_Extension {
    ...
    public function getFunctions()
    {
        return array(
            ...
            'pathInfoTwig' => new \Twig_Function_Method($this, 'pathInfo'),
            'stripSlashesTwig'=> new \Twig_Function_Method($this, 'stripSlashesTwig')
        );
    }
   ...
   //returns file infomation 
   public function pathInfo($src){
       return pathinfo($src);
   }
   
   //To decode html entities
   public function stripSlashesTwig($string){
