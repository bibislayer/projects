...
//src/Poker\UserBundle/Security/User/OpenIdUserManager.php

namespace Poker\UserBundle\Security;

use Fp\OpenIdBundle\Model\UserManager;
use Fp\OpenIdBundle\Model\IdentityManagerInterface;
use Doctrine\ORM\EntityManager;
use Poker\UserBundle\Entity\OpenIdIdentity;
...
class OpenIdUserManager extends UserManager {
    ...
    public function createUserFromIdentity($identity, array $attributes = array()) {
        ...
        $user = $this->entityManager->getRepository('PokerUserBundle:User')->findOneBy(array(
