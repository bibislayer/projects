...
use VM\StandardBundle\Entity\StdQuestionType;
use VM\StandardBundle\Form\StdQuestionTypeType;
...
class TypeQuestionController extends Controller
{
    public function boIndexAction() {
        ...
        $paginate->setView('VMStandardBundle:TypeQuestion:index.html.twig');
    ...
    public function boShowAction($id) {
        ...
        if($typeQuestion){
            ...
            $breadcrumbs->addItem('');
            return $this->render('VMStandardBundle:TypeQuestion:show.html.twig', array( 'typeQuestion' => $typeQuestion));
        }else{
    ...
    public function typeQuestionFormAction(){
        ...
        $formConf->setView('VMStandardBundle:TypeQuestion:type_question_form.html.twig');
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $typeQuestion = $em->getRepository('VMStandardBundle:StdQuestionType')->find($id);
