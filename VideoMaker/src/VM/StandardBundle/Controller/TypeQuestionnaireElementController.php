...
use VM\StandardBundle\Entity\StdQuestionnaireTypeElement;
use VM\StandardBundle\Form\StdQuestionnaireTypeElementType;
...
class TypeQuestionnaireElementController extends Controller
{
    public function boIndexAction() {
        ...
        $paginate->setView('VMStandardBundle:TypeQuestionnaireElement:index.html.twig');
    ...
    public function boShowAction($id) {
        ...
        if($typeQuestionnaireElement){
            ...
            $breadcrumbs->addItem('');
            return $this->render('VMStandardBundle:TypeQuestionnaireElement:show.html.twig', array( 'typeQuestionnaireElement' => $typeQuestionnaireElement));
        }else{
    ...
    public function typeQuestionnaireElementFormAction(){
        ...
        $formConf->setView('VMStandardBundle:TypeQuestionnaireElement:type_questionnaire_element_form.html.twig');
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $typeQuestionnaire = $em->getRepository('VMStandardBundle:StdQuestionnaireTypeElement')->find($id);
