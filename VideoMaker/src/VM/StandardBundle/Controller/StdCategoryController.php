...
use VM\StandardBundle\Entity\StdCategory;
use VM\StandardBundle\Form\StdCategoryType;
...
class StdCategoryController extends Controller {
    ...
    public function boIndexAction() {
        ...
        $paginate->setView('VMStandardBundle:StdCategory/Back:index.html.twig');
    ...
    public function boShowAction($id) {
        ...
        if($category){
            ...
            $breadcrumbs->addItem('');
            return $this->render('VMStandardBundle:StdCategory/Back:show.html.twig', array( 'category' => $category));
        }else{
    ...
    public function categoryFormAction(){
        ...
        $formConf->setView('VMStandardBundle:StdCategory/Back:category_form.html.twig');
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $category = $em->getRepository('VMStandardBundle:StdCategory')->find($id);
        if(is_object($category) && $category->getId()){
            $repo = $em->getRepository('VMStandardBundle:StdCategory');
