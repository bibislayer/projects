...
use VM\StandardBundle\Entity\StdQuestionnaireType;
use VM\StandardBundle\Form\StdQuestionnaireTypeType;
...
class TypeQuestionnaireController extends Controller
{
    public function boIndexAction() {
        ...
        $paginate->setView('VMStandardBundle:TypeQuestionnaire:index.html.twig');
    ...
    public function boShowAction($id) {
        ...
        if($typeQuestionnaire){
            ...
            $breadcrumbs->addItem('');
            return $this->render('VMStandardBundle:TypeQuestionnaire:show.html.twig', array( 'typeQuestionnaire' => $typeQuestionnaire));
        }else{
    ...
    public function typeQuestionnaireFormAction(){
        ...
        $formConf->setView('VMStandardBundle:TypeQuestionnaire:type_questionnaire_form.html.twig');
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $typeQuestionnaire = $em->getRepository('VMStandardBundle:StdQuestionnaireType')->find($id);
