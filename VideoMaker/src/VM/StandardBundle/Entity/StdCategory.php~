...
class StdCategory
{
    ...
    /**
     * @var \VM\StandardBundle\Entity\StdCategory
     */
    private $parent;
     ...
     * Add children
     *
     * @param \VM\StandardBundle\Entity\StdCategory $children
     * @return StdCategory
     */
    public function addChildren(\VM\StandardBundle\Entity\StdCategory $children)
    {
     ...
     * @param \VM\StandardBundle\Entity\StdCategory $children
     */
    public function removeChildren(\VM\StandardBundle\Entity\StdCategory $children)
    {
     ...
     * Set parent
     *
     * @param \VM\StandardBundle\Entity\StdCategory $parent
     * @return StdCategory
     */
    public function setParent(\VM\StandardBundle\Entity\StdCategory $parent = null)
    {
        $this->parent = $parent;
     ...
     * Get parent
     *
     * @return \VM\StandardBundle\Entity\StdCategory 
     */
     ...
     * @var \Doctrine\Common\Collections\Collection
     */
    private $CategoryQuestionnaire;


    /**
     * Add CategoryQuestionnaire
     *
     * @param \VM\QuestionnaireBundle\Entity\Questionnaire $categoryQuestionnaire
     * @return StdCategory
     */
    public function addCategoryQuestionnaire(\VM\QuestionnaireBundle\Entity\Questionnaire $categoryQuestionnaire)
    {
        $this->CategoryQuestionnaire[] = $categoryQuestionnaire;
    
        return $this;
    }

    /**
     * Remove CategoryQuestionnaire
     *
     * @param \VM\QuestionnaireBundle\Entity\Questionnaire $categoryQuestionnaire
     */
    public function removeCategoryQuestionnaire(\VM\QuestionnaireBundle\Entity\Questionnaire $categoryQuestionnaire)
    {
        $this->CategoryQuestionnaire->removeElement($categoryQuestionnaire);
    }

    /**
     * Get CategoryQuestionnaire
     *
     * @return \Doctrine\Common\Collections\Collection 
     */
    public function getCategoryQuestionnaire()
    {
