...
class ChangeEmailController extends Controller implements ContainerAwareInterface
{
    ...
    public function changeEmailAction(Request $request)
    {
        ...
        return $this->container->get('templating')->renderResponse(
            'VMUserBundle:ChangeEmail:changeEmail.html.'.$this->container->getParameter('fos_user.template.engine'),
    ...
    public function resetEmailAction(Request $request){
        ...
        if($request->get('token') && $request->get('email_new')){                        
            $userToken=$this->getDoctrine()->getManager()->createQuery('SELECT u FROM VMUserBundle:User u WHERE u.email_new = \''.$request->get('email_new').'\'')->getOneOrNullResult();
