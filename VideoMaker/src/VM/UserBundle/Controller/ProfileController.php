...
class ProfileController extends Controller implements ContainerAwareInterface
{
    ...
    public function showAction()
    {
        ...
        return $this->container->get('templating')->renderResponse('VMUserBundle:Profile:show.html.'.$this->container->getParameter('fos_user.template.engine'), array('user' => $user));
    }
    ...
    public function editAction(Request $request)
    {
        ...
        return $this->container->get('templating')->renderResponse(
            'VMUserBundle:Profile:edit.html.'.$this->container->getParameter('fos_user.template.engine'),
        ...
        return $this->render('VMUserBundle:Profile:tabsInfo.html.twig', array(
            'type' => $type,
        ));
