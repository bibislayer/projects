...
class FormModel
{
    ...
    /***
     * This will set a general help text in the generic form
     * @param $errors
     */
    public function addGeneralHelp($help = 'add'){
        $this->help = $help;
    }
    ...
    /***
     * This will set the current class for form
     * @param $class
     */
        ...
        switch($this->env):
            case 'bo_':
                if($this->ajax || $this->layout==false):
                    return 'VMGeneralBundle:Default:form.html.twig';
                else:
                    return 'VMGeneralBundle:Back:containerForm.html.twig';
                endif;
                break;
            case 'mo_':
                if($this->ajax || $this->layout==false):
                    ...
                    return 'VMGeneralBundle:Middle:containerForm.html.twig';
                endif;
                break;
            case 'fo_':
                if($this->ajax || $this->layout==false):
                    ...
                    return 'VMGeneralBundle:Front:containerForm.html.twig';
                endif;
                break;
        endswitch;
    }
