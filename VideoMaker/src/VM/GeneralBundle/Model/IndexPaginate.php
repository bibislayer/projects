...
class IndexPaginate
{
    ...
    public function getTemplate()
    {
        switch($this->env):
            case 'bo_':
                if($this->ajax):
                    return 'VMGeneralBundle:Default:list.html.twig';
                else:
                    return 'VMGeneralBundle:Back:containerList.html.twig';
                endif;
                break;
            case 'mo_':
                if($this->ajax):
                    ...
                    return 'VMGeneralBundle:Middle:containerList.html.twig';
                endif;
                break;
            case 'fo_':
                if($this->ajax):
                    ...
                    return 'VMGeneralBundle:Front:containerList.html.twig';
                endif;
                break;
        endswitch;
    }
